...
<tr style="border: 0;">
   ...
   <td valign="top">
      ...
      <p>
         <em> パフォーマンスの高いオンブランドのメールとMeta広告を作成します </em>。
      </p>
   </td>
   <td valign="top">
...
<td valign="top">
   ...
   <p>
      <em> ブランドに合わせたMeta広告エクスペリエンスを作成する方法を説明します </em>。
   </p>
</td>
</table>
...
[!BADGE Beta]{type=Informative url="https://experienceleague.adobe.com/ja/docs/core-services/interface/features/account-preferences#notifications" tooltip="Slackについて"}
