...
| [トリガー](https://experienceleague.adobe.com/ja/docs/core-services/interface/services/triggers) | Experience Cloudのトリガーを使用すると、主要なコンシューマーの行動を特定、定義、監視し、アプリケーション間のコミュニケーションを生み出して、訪問者を再び引き付けることができます。 リアルタイムでの意思決定とパーソナライゼーションに Triggers を使用できます。 |
