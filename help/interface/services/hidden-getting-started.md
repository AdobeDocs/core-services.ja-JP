...
既存のお客様は、アプリケーション実装を最新化し、CX Enterpriseを実装できます。 これにより、Adobe Analytics、Audience Manager、Adobe Target をまたいで顧客属性とオーディエンス機能を使用できます。

## CX Enterpriseに参加して管理者になる {#section_2423F0BD3DF642658103310EE5EA6154}

CX Enterpriseに参加するために必要な操作：
...
**[!UICONTROL Admin Console]** リンクは、CX Enterprise メニューナビゲーションで使用できます。
...
CX Enterpriseの[Link アカウントを参照](../administration/organizations.md)
...
CX Enterprise ID サービスの完全なヘルプ（以前の訪問者ID）については、[こちら](https://experienceleague.adobe.com/docs/id-service/using/intro/overview.html?lang=ja#intro)を参照してください。
...
## レポートスイートをCX Enterprise組織にマッピングする {#section_7B08516B01BA421681DF03D0E86CE3BA}
