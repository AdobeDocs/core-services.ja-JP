...
1. Experience Cloudで、**[!UICONTROL Administration]**/**[!UICONTROL Manage Creative Cloud Collaborators]** をクリックします。
1. 「**[!UICONTROL Creative Cloud Asset Sharing]**」をクリックします。
1. 「**[!UICONTROL Add New User]**」をクリックします。  ![&#x200B; 新規ユーザーを追加 &#x200B;](../../assets/mac_add_icon.png)
