...
| 問題 | 説明 |
|--- |--- |
| [!DNL Customer Attribute] サブスクリプションの制限 | Analytics Premium にアップグレードすると、追加の属性を使用できるようになるまでに 24 時間の遅延が生じます。この遅延の間に、[!UICONTROL attribute Subscription Max] エラーが発生することがあります。 |
