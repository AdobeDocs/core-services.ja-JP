...
[Experience Platform タグ &#x200B;](https://experienceleague.adobe.com/ja/docs/experience-platform/tags/home) を使用して最近Experience Cloudを実装した場合は、[&#x200B; 顧客属性 &#x200B;](../services/overview.md) とExperience Cloud [&#x200B; オーディエンス &#x200B;](../services/audiences/overview.md) に対して既に設定されています。 また、[Admin Console](../administration/admin-console.md) でユーザーと商品を管理することもできます。
...
Experience Cloud コアサービスを有効にする方法としては、[&#x200B; の &#x200B;](https://experienceleague.adobe.com/docs/experience-platform/tags/extensions/adobe/id-service/overview.html?lang=ja)Experience Cloud ID サービス拡張機能 [!UICONTROL Experience Platform Launch] を使用して、Analytics やAdobe Targetに対してコアサービスを自動的にアクティブにするのが最も簡単です。

>[!NOTE]
>
>Experience Cloud ID サービス（以前の訪問者 ID）のヘルプについて詳しくは、[Experience Cloud ID サービスの概要 &#x200B;](https://experienceleague.adobe.com/docs/id-service/using/intro/overview.html?lang=ja#intro) を参照してください。
...
* ライブラリが自動取得されるように、[Adobe Target拡張機能 &#x200B;](https://experienceleague.adobe.com/docs/experience-platform/tags/extensions/adobe/target-v2/overview.html?lang=ja) を [!UICONTROL Experience Platform] タグに追加することをお勧めします。 [&#x200B; タグを使用して、Adobe Target（およびその他のアプリケーション）用の &#x200B;](https://experienceleague.adobe.com/docs/experience-platform/tags/extensions/adobe/id-service/overview.html?lang=ja)0&rbrace;Experience Cloud ID サービス拡張機能 &rbrace; を設定することもできます。 [!UICONTROL Experience Platform]Adobe Targetが人物サービスを使用するには、[!UICONTROL Experience Cloud ID Service] の更新 **必須** が必要です。
