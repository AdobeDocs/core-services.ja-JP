...
>[!NOTE]
>
>CX Enterprise ID サービスの完全なヘルプ（以前の訪問者ID）については、[CX Enterprise Identity Serviceの概要](https://experienceleague.adobe.com/docs/id-service/using/intro/overview.html#intro)を参照してください。
