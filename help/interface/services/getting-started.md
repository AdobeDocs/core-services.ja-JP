...
Experience Platform タグを使用して最近Experience Cloudを実装した場合は、顧客属性とExperience Cloud オーディエンスに対して既に設定されています。 また、Admin Console でユーザーや製品を管理することもできます。
