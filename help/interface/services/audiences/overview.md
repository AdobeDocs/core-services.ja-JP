...
詳しくは、Adobe Analytics ドキュメントの [Experience CloudするPublish セグメント ](https://experienceleague.adobe.com/ja/docs/analytics/components/segmentation/segmentation-workflow/seg-publish) を参照してください。
