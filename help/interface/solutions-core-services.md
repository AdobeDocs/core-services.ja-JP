...
1. [Adobe Analytics 使用の手引き](https://marketing.adobe.com/resources/help/en_US/analytics/getting-started/)で説明されている手順に従い、最初の Analytics レポートスイート（データリポジトリ）を作成します。
1. 次に、[Launch, by Adobe](https://marketing.adobe.com/resources/help/en_US/experience-cloud/launch/) を使用して Analytics コードをデプロイします。

Experience Platform Launch は次世代のタグ管理ツールであり、あらゆる分析タグ、マーケティングタグ、広告タグを簡単にデプロイして管理することができます。

関連トピック:

* [使用する Analytics 製品の検討](https://marketing.adobe.com/resources/help/en_US/reference/which_analytics_tool.html)
* [Analytics 製品の比較と必要システム構成](https://marketing.adobe.com/resources/help/en_US/reference/analytics-product-comparison.html)
...
* [Target の設定](https://marketing.adobe.com/resources/help/en_US/target/ov/c_seting_up_target.html)
* [Target の仕組み](https://marketing.adobe.com/resources/help/en_US/target/ov/c_how_target_works.html)
* [管理者の最初の手順](https://marketing.adobe.com/resources/help/en_US/target/ov/start_target.html)
* [Target のレポートソースとしての Analytics](https://marketing.adobe.com/resources/help/en_US/target/a4t/a4t.html)

![](assets/mc_social_32.png) [Adobe Social](https://marketing.adobe.com/resources/help/en_US/social/)

Social は、加入形式のホストソリューションを提供して、ソーシャルメディアの目標達成と戦略およびパフォーマンスの改善を支援します。ソーシャルリスニング、パブリッシング、分析を可能にする包括的なプラットフォームで、ソーシャルマーケティングを管理できます。

[Social はじめに](https://marketing.adobe.com/resources/help/en_US/social/c_gs.html)
...
詳しくは、[Adobe Experience Manager 6.3](https://helpx.adobe.com/support/experience-manager/6-3.html) のページを参照してください。
...
| [Feed](feed.md) | Experience Cloud には共同作業のための機能が標準搭載されています。Feed を使用し、投稿、コメントおよび添付ファイルを共有できる一元的なフィードを通じてチームと常に連携します。 |
| [Mobile Services](https://marketing.adobe.com/resources/help/en_US/mobile/) | Adobe Mobile Services により、モバイルアプリ用の各ソリューションが Experience Cloud 上で統合されます。これにより、アプリの利用状況を把握し、改善につなげることができます。 |
