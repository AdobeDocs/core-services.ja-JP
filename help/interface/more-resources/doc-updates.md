---
description: CX Enterpriseの一般的なインターフェイスコンポーネントに関するドキュメントの更新が発生する場所について説明します。
...
* 概要、ユーザー、フィードバック、AI クレジットの表示、会話の再生、ガバナンスユーザーの権限など、[Agentic AI利用状況モニタリング ](../features/monitoring.md)を公開し、ライセンス利用状況とAgentic AI監視ダッシュボードについて説明しました。
...
* 説明、リンクテキスト、自動タグ付けメタデータなど、ガイド全体でExperience Cloudから&#x200B;**CX Enterprise**&#x200B;へのリブランドされたドキュメント。
* `https://experience.adobe.com/home`に更新されたホームページの[2026年4月のリリースノート ](release-notes.md)を追加しました（UIの更新、ダークモード、アクセシビリティの改善）。
* CX Enterprise](../features/agentic-ai.md)の[Agentic AIを更新しました：Adobe Marketing Agent for Microsoft 365 Copilot、修正されたエージェント機能、およびexisting-apps エージェントテーブルの&#x200B;**Health Data / HIPAA対応**&#x200B;列。
...
統合ドキュメントをまとめた[CX Enterprise Integrations](../administration/integrations.md)を追加しました。
