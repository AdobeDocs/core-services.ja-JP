...
| **[!UICONTROL Experience CloudID サービス ] （ECID）** | 特別な用法はありません。 | サイト訪問者に割り当てられる一意の永続的な ID。Experience Platform ID サービスで使用できる特定のエンティティです。[詳細情報...](https://experienceleague.adobe.com/docs/id-service/using/home.html?lang=ja) |
