...
管理者は、すべてのExperience Cloudユーザーの並べ替え可能なフィルター可能なリストと、その詳細を管理ツールで表示できます。 管理ツー [ルの表示Experience Cloudユーザーを参照してください](admin-tool-experience-cloud.md)。
...
[Creative Cloudおよびドキュメント](https://helpx.adobe.com/enterprise/using/users.html) Cloudの管理ユーザーガイドを参照してください。 IDタイプの管理など、Experience Cloudのユーザー管理に関連する情 [報があります](https://helpx.adobe.com/enterprise/help/identity.html)。
...
製品プロファイルの追加は、ソリューション製品やサービスの以前の管理方法（グループを使用）からの移行を示します。 管理コンソールでは、製品プロファイル（ユーザーに割り当て可能な製品とサービスのグループ）に基づいて権限が設定されます。

例えば、Analyticsでは、分析ワークスペースやReport Builderなどのレポートツールの集まりと、レポートスイート、指標、ディメンションなどを設定できます。 ユーザーを製品プロファイルに追加すると、そのプロファイルに See [Assign Analytics access permissions to a product profile](../admin-getting-started/admin-getting-started.md#task_040673FE3E3E429B9531FBCB8B6A4391).
...
アドビのターゲットでは、ワークスペースは製品プロファイルです。 組織は、特定のユーザーのセットを特定のプロパティのセットに割り当てることができます。 多くの点で、ワークスペースは Adobe Analytics のレポートスイートに似ています。
...
* [製品とプロファイル](https://helpx.adobe.com/enterprise/using/manage-products-and-profiles.html)
* ビデオ：Adobe管理コ [ンソールでのAdobeターゲットワークスペースの設定方法](https://helpx.adobe.com/target/kb/how-to-configure-target-workspaces-in-adobe-admin-console0.html)
...
*セキュリティグループは* 、製品のプロファイルとして表示されます。
...
エクスペリエンスプラットフォームの起動は、管理コンソールの製品ページに表示されます。 他のソリューションやサービスを起動製品プロファイルに含める。

管理コン [ソールでのユーザ権限、](https://docs.adobelaunch.com/launch-reference/administration/user-permissions) 「ユーザ管理」を参照して、起動固有のオプション（ユーザへの権限の割り当てを含む）を設定します。
...
詳しくは、 [オーディエンス](https://docs.adobe.com/content/help/en/dtm/using/admin/users.html) ・マネージャのヘルプ

## Experience Cloud 製品の管理 {#task_16335111C52D40E9BAC73D0699584DBF}

製品プロファイルを作成し、権限グループに割り当てます。

ユーザーを組織に招待する場合、製品と製品のユーザーへのアクセス権をユーザーに付与できます。プロファイル また、制限付き管理権限をユーザーに委任することもできます。 同様に、ユーザーグループを作成し、そのグループを製品プロファイルに追加してアクセスできます。
...
* [製品とプロファイル](https://helpx.adobe.com/enterprise/using/manage-products-and-profiles.html)
* [Enterprise User Permissions](https://docs.adobe.com/content/help/en/target/using/administer/manage-users/enterprise/property-channel.html) (Adobeターゲットヘルプ)を参照してください。
* ビデオ：Adobe管理コ [ンソールでのAdobeターゲットワークスペースの設定方法](https://helpx.adobe.com/target/kb/how-to-configure-target-workspaces-in-adobe-admin-console0.html)
...
| レポートスイートツール | Webサービス、レポートスイートの管理、ツールとレポート、およびダッシュボード項目のユーザー権限の有効化 |
