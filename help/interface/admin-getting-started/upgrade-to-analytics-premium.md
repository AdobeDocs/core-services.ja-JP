...
アルゴリズムアトリビューションテンプレートについては、[最適なアトリビューション](https://marketing.adobe.com/resources/help/en_US/insight/client/?f=c_attrib_algorithmic)を参照してください。が格納されます。

## Experience Cloud - ユーザーと製品の管理 {#section_6471C54454024301B2E0B687F79F6738}

Experience Cloudおよびコアサービスは、Analytics StandardおよびPremiumのユーザーが利用できます。これには、「はじめに-コアサービスのソリューションを有効にする」の [実装の最新化が記載](../core-services/core-services.md#concept_07ED1D5C64234E77976E6D572E78FB9C)されています。（このプロセスにより、実装を最新化できます。また、Experience Cloud の管理者になることもできます）。
...
>[!NOTE]
>
>複数のソリューショングループを1つの管理コンソールグループにマッピングできます。ただし、1 対 1 のマッピングをお勧めします。事前にグループをマッピングしておくと、CSV をアップロードすることで、複数のユーザーを招待、作成、承認および追加できます。
