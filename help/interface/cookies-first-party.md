...
>[!NOTE]
> 以前は、Adobeでは、HTTPS 用と HTTP 用の 2 つの CNAME を設定することをお勧めしていました。 トラフィックを暗号化することをお勧めします。また、ほとんどのブラウザーでは HTTP を強くお勧めしません。そのため、HTTP に CNAME を設定することはお勧めしません。 HTTP 用の CNAME の設定については、Adobeカスタマーケアにお問い合わせください。
