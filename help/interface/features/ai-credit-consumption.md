...
| 製品サポート担当者 | サポートケースの作成とトラッキング | <ul><li>Real-Time CDP（B2B、B2C、B2P の各エディション）</li>Adobe Journey Optimizer（B2C と B2B のエディション）<li>Customer Journey Analytics（B2C と B2B のエディション）</li><li>Adobe Experience Manager</li></ul> | 10 | <ul><li><em> 失敗したセグメント化ジョブの新しいサポートチケットを作成する </em></li><li><em> チケット E-001772068 のステータスを教えてください。</em></li></ul> |
