...
| コンテンツ アドバイザーエージェント | コンテンツ検出 | <ul><li>Adobe Experience Manager Assets</li></ul> | 5 | <ul><li>_WKND オファーキャンペーン作成用のコンテンツフラグメントを表示します_。</li><li>_製品パッケージの PNG 画像を検索します_。</li><li>_Office タグ付き画像をフォルダー WKND に表示します。_</li><li>_フォルダー WKND に svg はありますか？_</li><li>_すべてのローン申し込みフォームを表示する_</li><li>_従業員のオンボーディングフォームを探しています。_</li></ul> |
| コンテンツ アドバイザーエージェント | <ul><li>コンテンツの最適化</li></ul> | <ul><li>Adobe Experience Manager Assets</li></ul> | 10 | <ul><li>_80% の画質で、2000 px のレンディションをJPEGとして作成します。_</li><li>_Instagram ストーリーのレンディションの作成_</li><li>_プロモーションバナーの上に 30% 割引のグラフィックを重ねて、中央から 100 ピクセル配置します。_</li><li>_PNG の背景色を#ff8932 に変更します。_</li></ul> |
| ブランドガバナンスエージェント | <ul><li>コンテンツの更新</li><li>Formsの作成</li><li>パイプラインのトラブルシューティング</li></ul> | <ul><li>Adobe Experience Manager Cloud Services</li><li>Adobe Experience Manager Sites</li><li>Adobe Experience Manager Forms</li></ul> | 50 | <ul><li>_失敗したパイプラインのトラブルシューティング_</li><li>_失敗したパイプラインをメインプログラムにリストします_。</li><li>_「開発パイプライン」という失敗したパイプラインを分析_</li><li>_パイプライン実行 1234567_ のトラブルシューティング</li></ul> |
| Brand Experience エージェント | サイトの最新化 | Adobe Experience Manager Cloud Services | 100 | <ul><li>_ページを移行する`https://wknd-trendsetters.site`_</li></ul> |
...
* [Adobe Experience Platform エージェントの使用にバインドされた体験版 &#x200B;](https://experienceleague.adobe.com/ja/docs/experience-cloud-ai/experience-cloud-ai/agents/trial)
