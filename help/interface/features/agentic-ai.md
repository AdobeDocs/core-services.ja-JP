...
Adobe Experience Platform Agentsは、[Experience Platform Agent Orchestrator](https://experienceleague.adobe.com/en/docs/experience-cloud-ai/experience-cloud-ai/home)によって強化され、CX Enterprise アプリケーション内でエージェント型AI機能を有効にします。
