...
description: Experience Cloud アプリケーションでのジェネレーティブ AI （GenAI）および AI アシスタントに関するお問い合わせ。
...
* **応答を生成：** AI は、通常、使用可能なデータとナレッジリポジトリを利用して、プロンプトに対する回答や反応を提供します。
  ...
  GenAI は、自律的に機能する AI を指す [Agentic AI](agentic-ai.md) （Adobeの Agentic Framework）とは対照的です。
