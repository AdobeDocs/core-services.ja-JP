...
生成 AI 機能と AI アシスタントを使用する [!DNL Experience Cloud] アプリケーションの概要を説明します。 ジェネレーティブ AI 機能には [0}Adobe Firefly} との互換性が示されています。](https://business.adobe.com/products/firefly-business/firefly-ai-approach.html)
...
AEM Sitesでは、_[!UICONTROL Generate Variations]_を使用できます。 この機能は、ジェネレーティブな人工知能を使用して、入力プロンプトに基づくコンテンツのバリエーションを作成します。 プロンプトは、Adobeから提供されるか、ユーザーが作成および管理します。
