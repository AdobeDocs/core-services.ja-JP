...
| ヘルプリンク | 説明 |
| ------- | ------- |
| [Adobe IDをリセット ](https://helpx.adobe.com/manage-account/kb/account-password-sign-help.html) | ログアウトしてから、**[!UICONTROL サインインに関するヘルプを表示]** > **[!UICONTROL パスワードをリセット]** をクリックしてください。 |
