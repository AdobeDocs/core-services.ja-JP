...
| ヘルプリンク | 説明 |
| ------- | ------- |
| [Adobe IDをリセット ](https://helpx.adobe.com/manage-account/kb/account-password-sign-help.html) | ログアウトし、**[!UICONTROL Get help signing in]**/**[!UICONTROL Reset your password]** をクリックします。 |
