...
Adobe[Admin Console](https://adminconsole.adobe.com/enterprise/)でユーザーと製品ライセンスを管理できます。 すべてのAdobeアプリケーションに適用される一般的なID管理ヘルプについては、[エンタープライズ版およびグループ版の管理者ガイド](https://helpx.adobe.com/jp/enterprise/admin-guide.html)を参照してください。
...
| 役割 | 説明 |
| ------- | ------- |
| システム管理者 | フルアクセス – コンソールのすべての側面を管理します。 <br> 主な責務：<br><ul><li>ユーザーを追加、削除、管理します。</li><li>製品ライセンスの割り当てと失効。</li><li>ID および認証設定の指定</li><li>請求情報を表示および管理します。</li><li>追加の管理者を設定し、役割を委任します。</li></ul> **最適：**&#x200B;組織全体のAdobe環境を管理するIT管理者またはチームリーダー。 |
| 製品管理者 | 製品固有の管理：特定のAdobe製品に対するアクセス権とアクセス権を制御します。<br>主な責務：<ul><li>特定の製品に対するライセンスの割り当てと管理</li><li>製品プロファイルを作成および管理します。</li><li>割り当てられた製品内のユーザーを追加または削除します。</li></ul>   **最適：** Marketo EngageやAdobe Creative Cloudなど、特定のソフトウェアを管理するチームまたはユーザー。 |
...
| ヘルプリンク | 説明 |
| ------- | ------ |
| [IDとシングルサインオンの設定](https://helpx.adobe.com/jp/enterprise/using/set-up-identity.html) | **[!UICONTROL Admin Console]** > **[!UICONTROL Settings]** <br>シングルサインオン(SSO)を使用して、または使用せずに、さまざまなIDの種類でユーザーのアカウントを設定する方法を説明します。 Adobeソフトウェア用のSSOの設定、SAML設定の構成、および一般的な質問とエラーについて確認します。 |
| [ディレクトリの信頼を使用して組織を設定する](https://helpx.adobe.com/jp/enterprise/using/directory-trust.html) | 別の組織によって既に要求されているドメインに対してユーザーを認証します。 組織の検索と切り替えの詳細については、[Experience Cloud内の組織](organizations.md)を参照してください。 |
| [認証設定（エンタープライズ）](https://helpx.adobe.com/jp/enterprise/using/authentication-settings.html) | Admin Consoleでは、安全性とセキュリティを確保するために、複数のパスワード保護レベルおよびポリシーをサポートしています。 パスワード保護レベルを使用して、組織全体のすべてのユーザーに適用するように指定できます。 |
| [&#x200B; プライバシーおよびセキュリティに関する連絡先 &#x200B;](https://helpx.adobe.com/jp/enterprise/using/security-contacts.html) | 組織およびユーザーのデータを保護します。 当社のソフトウェアソリューションに関するセキュリティインシデントが発生した場合、適切なコンプライアンス担当者に通知が送信されます。 企業には、データ保護、整合性、その他のコンプライアンスに関する事項に固有の役割を持つスタッフがいます。 したがって、セキュリティの問題が発生した場合に迅速な通知を確実に行うために、これらの担当者の連絡先情報が重要になります。 |

### ユーザー管理

| ヘルプリンク | 説明 |
| ------- | ------- |
| [Adobe IDをリセット &#x200B;](https://helpx.adobe.com/jp/account/individual/sign-in-and-security/security-and-recovery/cant-sign-in-to-adobe-account.html) | ログアウトし、**[!UICONTROL Get help signing in]**/**[!UICONTROL Reset your password]** をクリックします。 |
| [&#x200B; 複数ユーザーの管理 &#x200B;](https://helpx.adobe.com/jp/enterprise/using/bulk-upload-users.html) | **[!UICONTROL Admin Console]** > **[!UICONTROL Users]** <br>Admin Consoleへの CSV バルクアップロードを使用して複数のユーザーを管理する方法について説明します。 |
...
| [&#x200B; ユーザー同期ツール &#x200B;](https://helpx.adobe.com/jp/enterprise/using/user-sync.html) （UST） | Adobeユーザー同期ツールは、組織のID管理システム（Active Directoryなど）とAdobe Admin Console間のユーザーデータの同期を自動化するために使用されるデスクトップアプリケーションです。 管理者はこのツールを使用して、Adobe製品間でユーザープロビジョニング、アップデート、アクティベーション解除を合理化できます。 |
| [ユーザーの詳細の表示（管理ツール）](admin-tool-experience-cloud.md) | [!UICONTROL Admin Tool]内の詳細を含むすべてのExperience Cloudユーザーとポリシーの並べ替え可能でフィルター可能な一覧を表示します。 |

### レポートとログ

| ヘルプリンク | 説明 |
| ------- | ------- |
| [&#x200B; 監査ログ &#x200B;](https://helpx.adobe.com/jp/enterprise/using/audit-logs.html) | **[!UICONTROL Insights]** > **[!UICONTROL Logs]** > **[!UICONTROL Audit Log]** <br> Admin Consoleで行われたすべての変更を追跡します。 |
...
* [Advertising検索、ソーシャル、Commerce](https://experienceleague.adobe.com/ja/docs/advertising/search-social-commerce/target/user-administration)
...
* [Experience Platform](https://experienceleague.adobe.com/ja/docs/experience-platform/access-control/ui/overview)と[データ収集](https://experienceleague.adobe.com/ja/docs/experience-platform/collection/permissions)
...
* [Journey OptimizerB2B edition](https://experienceleague.adobe.com/ja/docs/journey-optimizer-b2b/user/admin/user-management)
...
* [Target](https://experienceleague.adobe.com/ja/docs/target/using/administer/start-target)
