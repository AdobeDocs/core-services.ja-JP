...
| ヘルプリンク | 説明 |
| ------- | ------- |
| [Adobe IDをリセット ](https://helpx.adobe.com/jp/manage-account/kb/account-password-sign-help.html) | ログアウトしてから、**[!UICONTROL サインインに関するヘルプを表示]** > **[!UICONTROL パスワードをリセット]** をクリックしてください。 |
| [ 複数ユーザーの管理 ](https://helpx.adobe.com/jp/enterprise/using/bulk-upload-users.html) | **[!UICONTROL Admin Console]** > **[!UICONTROL ユーザー]** <br>Admin Consoleへの CSV 一括アップロードを使用して複数のユーザーを管理する方法を説明します。 |
...
| [!DNL Pass] | [Get started with Account IQ](https://experienceleague.adobe.com/ja/docs/pass/aiq-help/get-started) |
...
* [Adobe Pass](https://experienceleague.adobe.com/ja/docs/pass/aiq-help/get-started)
