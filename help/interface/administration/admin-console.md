...
| ヘルプリンク | 説明 |
| ------- | ------- |
| [Adobe IDをリセット &#x200B;](https://helpx.adobe.com/jp/manage-account/kb/account-password-sign-help.html) | ログアウトし、**[!UICONTROL Get help signing in]**/**[!UICONTROL Reset your password]** をクリックします。 |
...
* [Advertising検索、ソーシャル、Commerce](https://experienceleague.adobe.com/ja/docs/advertising/search-social-commerce/new-ui/user-administration)
