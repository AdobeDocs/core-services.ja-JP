...
| [ディレクトリの信頼を使用して組織を設定する](https://helpx.adobe.com/enterprise/using/directory-trust.html) | 別の組織によって既に要求されているドメインに対してユーザーを認証します。 組織の検索と切り替えの詳細については、[Experience Cloud内の組織](organizations.md)を参照してください。 |
...
| [ プライバシーおよびセキュリティに関する連絡先 ](https://helpx.adobe.com/enterprise/using/security-contacts.html) | 組織およびユーザーのデータを保護します。 当社のソフトウェアソリューションに関するセキュリティインシデントが発生した場合、適切なコンプライアンス担当者に通知が送信されます。 企業には、データ保護、整合性、その他のコンプライアンスに関する事項に固有の役割を持つスタッフがいます。 したがって、セキュリティの問題が発生した場合に迅速な通知を確実に行うために、これらの担当者の連絡先情報が重要になります。 |

### ユーザー管理

| ヘルプリンク | 説明 |
| ------- | ------- |
| [Adobe IDをリセット ](https://helpx.adobe.com/account/individual/sign-in-and-security/security-and-recovery/cant-sign-in-to-adobe-account.html) | ログアウトし、**[!UICONTROL Get help signing in]**/**[!UICONTROL Reset your password]** をクリックします。 |
| [ 複数ユーザーの管理 ](https://helpx.adobe.com/enterprise/using/bulk-upload-users.html) | **[!UICONTROL Admin Console]** > **[!UICONTROL Users]** <br>Admin Consoleへの CSV バルクアップロードを使用して複数のユーザーを管理する方法について説明します。 |
...
| [ ユーザー同期ツール ](https://helpx.adobe.com/enterprise/using/user-sync.html) （UST） | Adobeユーザー同期ツールは、組織のID管理システム（Active Directoryなど）とAdobe Admin Console間のユーザーデータの同期を自動化するために使用されるデスクトップアプリケーションです。 管理者はこのツールを使用して、Adobe製品間でユーザープロビジョニング、アップデート、アクティベーション解除を合理化できます。 |
...
| ヘルプリンク | 説明 |
| ------- | ------- |
| [ 監査ログ ](https://helpx.adobe.com/enterprise/using/audit-logs.html) | **[!UICONTROL Insights]** > **[!UICONTROL Logs]** > **[!UICONTROL Audit Log]** <br> Admin Consoleで行われたすべての変更を追跡します。 |
...
* [Advertising検索、ソーシャル、Commerce](https://experienceleague.adobe.com/en/docs/advertising/search-social-commerce/target/user-administration)
...
* [Experience Platform](https://experienceleague.adobe.com/en/docs/experience-platform/access-control/ui/overview)と[データ収集](https://experienceleague.adobe.com/en/docs/experience-platform/collection/permissions)
