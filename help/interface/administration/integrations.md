---
description: Adobe Experience Cloudで利用可能なアプリケーション統合を検索します。
...
## Experience Cloud アプリケーションの Platform サービスへの対応
...
* [!DNL Analytics] を使用して、[!DNL Target] および [!UICONTROL Platform Data Collection] の実装を最新化する。
...
* [Adobe Analytics](https://experienceleague.adobe.com/ja/docs/analytics/implementation/id/overview)
* [Adobe Target](https://experienceleague.adobe.com/ja/docs/id-service/using/implementation/setup-target)

## オーディエンス

ヘルプ：[オーディエンス](/help/interface/services/audiences/overview.md)

Experience Cloud [!UICONTROL Audience Library] でオーディエンスを作成および管理します。 オーディエンスは、次のような各種ソースから作成または取得できます。
...
* Adobe Target：顧客属性を使用するためのAdobe Target [&#x200B; サブスクリプション &#x200B;](/help/interface/services/customer-attributes/subscription.md) の設定
