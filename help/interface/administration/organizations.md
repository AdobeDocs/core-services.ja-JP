...
[&#x200B; フェデレーションゲストアクセス &#x200B;](https://helpx.adobe.com/business/enterprise/using/federated-guest-access.html)を有効にして、自分のドメインでゲストユーザーを安全に認証できます。 これらのユーザーは、任意のCX Enterprise ページの既存の組織内のアカウントを切り替えることができます。
