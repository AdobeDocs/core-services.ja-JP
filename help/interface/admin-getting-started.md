---
title: ユーザーと製品を管理する
description: Admin Consoleにログインし、Experience Cloudのユーザー権限と製品（製品プロファイル）を管理します。 Experience Cloud ユーザーへの管理権限の委任、および Experience Cloud に対するブラウザーのサポートについて説明します。
solution: Admin
index: true
