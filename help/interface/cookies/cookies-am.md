  ...
  <tr> 
   ...
   <td colname="col2"> <p> 
     <ul id="ul_11291DA87C5045E880034E06C863BCDA"> 
      ...
      <li id="li_A589EDA2198249829207A183872EF1FF">オプトアウト：ユーザーがデータ収集からオプトアウトすると、<span class="keyword">Audience Manager</span> は <span class="codeph">Do Not Target</span> という文字列を追加してこの cookie をリセットします。この場合、cookie の TTL は 10 年に設定されます。 </li> 
     </ul> </p> </td> 
  </tr> 
 </tbody> 
</table>
  ...
  <tr> 
   ...
   <td colname="col2"> <p> 
     <ul id="ul_4922AC2CD55D4C888A6FBEB22F8B889B"> 
      ...
      <li id="li_6B8C674EFAAC4DABA0A640CF29247F99">オプトアウト：ユーザーがデータ収集からオプトアウトすると、<span class="keyword">Audience Manager</span> は <span class="codeph">Do Not Target</span> という文字列を追加してこの cookie をリセットします。この場合、cookie の TTL は 10 年に設定されます。 </li> 
     </ul> </p> </td> 
  </tr> 
 </tbody> 
</table>
  ...
  <tr> 
   ...
   <td colname="col2"> <p> 
     <ul id="ul_5D13DD701B484B51BF2808A69A919106"> 
      ...
      <li id="li_A682B566704F43D2AB72487EFF212474">オプトアウト：ユーザーがデータ収集からオプトアウトすると、<span class="keyword">Audience Manager</span> は <span class="codeph">Do Not Target</span> という文字列を追加してこの cookie をリセットします。 </li> 
     </ul> </p> </td> 
  </tr> 
 </tbody> 
</table>
