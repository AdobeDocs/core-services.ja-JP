...
CX Enterprise ヘッダーから、次の操作を実行できます。
...
Adobeは、マーケティングアプリ、Creative Cloud、Experience League、サポートサイトで同様の名前を使用しています。 これらの用語がCX Enterpriseと他の場所でどのように適用されるかを簡単に比較するには、[用語](more-resources/terms.md)を参照してください。
