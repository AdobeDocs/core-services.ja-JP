...
Adobe Analyticsで Cookie を使用して訪問者を識別する方法について詳しくは、[Adobe Analyticsでの訪問者の識別 ](https://experienceleague.adobe.com/en/docs/analytics/implementation/id/overview) を参照してください。
