...
Adobe Analyticsで Cookie を使用して訪問者を識別する方法について詳しくは、[Adobe Analyticsでの訪問者の識別 &#x200B;](https://experienceleague.adobe.com/ja/docs/analytics/implementation/id/overview) を参照してください。
...
* **訪問者の識別が失われます：** Cookie が削除されると、Adobe Analyticsは再訪問者を認識できません。 次回ユーザーがサイトを訪問すると、新規訪問者としてカウントされます。
